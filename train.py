import torch
from horse_zebra_dataset import HorseZebraDataset
...
def main():
    ...
    dataset = HorseZebraDataset(
        root_horse=os.path.join(config.TRAIN_DIR, "trainA"),
        root_zebra=os.path.join(config.TRAIN_DIR, "trainB"),
        transform=config.transforms,
    )

    # Validation dataset
    val_dataset = HorseZebraDataset(
        root_horse=os.path.join(config.TRAIN_DIR, "testA"),
        root_zebra=os.path.join(config.TRAIN_DIR, "testB"),
        transform=config.transforms,
    )
